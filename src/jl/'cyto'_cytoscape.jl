...
class attribute).
- `dblTapData` (Dict; optional): The data with position of tap when double tapped on background. Read-only.
- `dblTapEdge` (optional): The complete edge dictionary returned when you double tap or double click it. Read-only.. dblTapEdge has the following type: lists containing elements 'isLoop', 'isSimple', 'midpoint', 'sourceData', 'sourceEndpoint', 'targetData', 'targetEndpoint', 'timeStamp', 'classes', 'data', 'grabbable', 'group', 'locked', 'selectable', 'selected', 'style'.
...
- `dblTapEdgeData` (Dict; optional): The data dictionary of an edge returned when you double tap or double click it. Read-only.
- `dblTapNode` (optional): The complete node dictionary returned when you double tap or double click on it. Read-only.. dblTapNode has the following type: lists containing elements 'edgesData', 'renderedPosition', 'timeStamp', 'classes', 'data', 'grabbable', 'group', 'locked', 'position', 'selectable', 'selected', 'style', 'ancestorsData', 'childrenData', 'descendantsData', 'parentData', 'siblingsData', 'isParent', 'isChildless', 'isChild', 'isOrphan', 'relativePosition'.
Those elements have the following types:
...
- `dblTapNodeData` (Dict; optional): The data dictionary of a node returned when you double tap or double click it. Read-only.
- `ehcompleteSource` (Dict; optional): Information and data about source of newly created edge by edgehandlers
- `ehcompleteTarget` (Dict; optional): Information and data about source of newly created edge by edgehandlers
- `ele_move_data` (Dict; optional): Data about moved node in canvas
- `ele_move_pos` (Dict; optional): Information about position of moved node in canvas
...
- `tapData` (Dict; optional): The data with position of tap when tapped on background. Read-only.
...
function 'cyto'_cytoscape(; kwargs...)
        available_props = Symbol[:id, :autoRefreshLayout, :autolock, :autoungrabify, :autounselectify, :boxSelectionEnabled, :className, :dblTapData, :dblTapEdge, :dblTapEdgeData, :dblTapNode, :dblTapNodeData, :ehcompleteSource, :ehcompleteTarget, :ele_move_data, :ele_move_pos, :elements, :generateImage, :imageData, :layout, :maxZoom, :minZoom, :mouseoverEdgeData, :mouseoverNodeData, :pan, :panningEnabled, :responsive, :selectedEdgeData, :selectedNodeData, :style, :stylesheet, :tapData, :tapEdge, :tapEdgeData, :tapNode, :tapNodeData, :userPanningEnabled, :userZoomingEnabled, :zoom, :zoomingEnabled]
        wild_props = Symbol[]
